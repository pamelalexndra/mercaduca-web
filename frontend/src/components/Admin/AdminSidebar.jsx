...
const menuItems = [
  { icon: <ClipboardList size={20}/>, label: "Solicitudes", path: "/Admin/entrepreneurship-applications" },
  { icon: <LayoutDashboard size={20}/>, label: "Actividades", path: "/Admin/activity-management" },
...
export default function AdminSidebar() {
  return (
    <aside className="w-64 bg-white rounded-3xl shadow-xl p-6 h-fit sticky top-10 border border-gray-50">
      <h2 className="font-loubag text-[#557051] text-xl mb-8 px-2">Panel Admin</h2>
