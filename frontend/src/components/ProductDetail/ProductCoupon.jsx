...
export default function ProductCoupon({ cupon }) {
  if (!cupon) return null;

  let mensaje = "Ahorra con este cupón";
  ...
  if (cupon.id_producto) {
    ...
    mensaje = "Ahorra en productos de esta tienda";
  }
    ...
    <div className="mt-4 rounded-xl border border-[#557051]/20 bg-[#557051]/5 p-4 font-montserrat">
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          ...
          <button className="mt-3 text-xs font-semibold bg-[#557051] text-white px-4 py-1.5 rounded-lg hover:opacity-90 transition">
            Aplicar cupón
          </button>
        </div>
      </div>
